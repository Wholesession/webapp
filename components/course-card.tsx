...
export function CourseCard({ course }: CourseCardProps) {
    return (
        <Link href={`/course/${course.slug}`} className="group relative flex flex-col justify-between rounded-2xl bg-white p-8 ring-1 ring-gray-200 transition-all hover:shadow-lg hover:ring-purple-100 h-full overflow-hidden font-body">
