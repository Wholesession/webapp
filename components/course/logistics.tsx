    ...
    return (
        <section className="text-white">
            ...
            <div className="relative z-10">
                ...
                {/* Audience Section */}
                <div>
                    <h3 className="text-4xl font-serif text-black mb-6">Who is this for?</h3>
                    ...
                    {course.prerequisites && (
                        <div className="mt-12">
                            <h4 className="text-4xl font-serif font-normal text-black mb-6">Prerequisites</h4>
                ...
                <div className="space-y-6">
                    <div>
                        <h3 className="text-4xl font-serif font-normal text-black mb-6 mt-12">How you'll learn</h3>
                        <div className="space-y-4">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h4 className="font-semibold text-black text-[1rem] mb-1">Teaching Style</h4>
                                    <p className="text-[1rem] text-gray-700 leading-relaxed">{course.logistics.teachingStyle}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h4 className="font-semibold text-black text-[1rem] mb-1">Commitment</h4>
                    ...
                    {course.tools && course.tools.length > 0 && (
                        <div className="pt-6 border-t border-white/10 mt-12">
                            <div className="flex items-center gap-2 mb-3">
                                ...
                                <h4 className="text-4xl font-serif font-normal text-black">Tools & Stack</h4>
                            </div>
                            <div className="flex flex-wrap gap-2">
                                {course.tools.map((tool, i) => (
                                    <span key={i} className="px-2 py-2 rounded-md text-xs text-black border border-white/5 text-[1rem] bg-gray-100">
                                        {tool}
                                    </span>
                                ))}
                            </div>
