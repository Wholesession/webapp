...
export function Navbar() {
    ...
    useEffect(() => {
        const handleScroll = () => {
            // Change navbar style when scrolled past 100px
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="hidden lg:flex items-center justify-center flex-1 mx-8">
                            <div className="flex items-center gap-1 px-2 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/10">
                                {navLinks.map((link) => (
                                    <Link
                                        key={link.name}
                                        href={link.href}
